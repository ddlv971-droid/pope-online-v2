...
(function(){
  ...
  function selectDomain(btn){ qsa('.v5-domain-pill').forEach(function(b){b.classList.remove('selected');}); btn.classList.add('selected'); _domain=btn.getAttribute('data-domain')||btn.textContent.trim(); setTimeout(function(){ goStep(2); }, 120); }
